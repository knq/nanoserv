 ...
 * @since 0.9
 */
class IPCSocket extends Socket {
 ...
 * @since 0.9
 */
class StaticWriteBuffer extends WriteBuffer implements IWriteBuffer {
 ...
 * @since 2.1
 */
class StreamWriteBuffer extends WriteBuffer implements IWriteBuffer {
 ...
 * @since 0.9.61
 */
abstract class DatagramHandler extends Handler {
 ...
 * @since 0.9
 */
abstract class ConnectionHandler extends Handler {
